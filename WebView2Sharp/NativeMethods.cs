...
namespace WebView2Sharp
{
    public static class NativeMethods
    {
        ...
        //[DllImport("WebView2Loader.dll")]
        //public static extern int GetWebView2BrowserVersionInfo(string browserExecutableFolder, [MarshalAs(UnmanagedType.LPWStr)] out string versionInfo);
        //[DllImport("WebView2Loader.dll")]
        //public static extern int CompareBrowserVersions(string version1, string version2, out int result);
        ...
        {
            [MethodImpl(MethodImplOptions.InternalCall)]
            void add_NewVersionAvailable([MarshalAs(UnmanagedType.Interface)] [In] IWebView2NewVersionAvailableEventHandler eventHandler, out EventRegistrationToken token);
            [MethodImpl(MethodImplOptions.InternalCall)]
        ...
        [Guid("BB2DA827-0632-4ED6-8EDA-3F9E561767CA"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
        [ComImport]
        ...
        public interface IWebView2WebView3 : IWebView2WebView
        {
            ...
            void Stop();
            [MethodImpl(MethodImplOptions.InternalCall)]
            void add_NewWindowRequested([MarshalAs(UnmanagedType.Interface)] [In] IWebView2NewWindowRequestedEventHandler eventHandler, out EventRegistrationToken token);
            [MethodImpl(MethodImplOptions.InternalCall)]
            void remove_NewWindowRequested([In] EventRegistrationToken token);
            [MethodImpl(MethodImplOptions.InternalCall)]
            void add_DocumentTitleChanged([MarshalAs(UnmanagedType.Interface)] [In] IWebView2DocumentTitleChangedEventHandler eventHandler, out EventRegistrationToken token);
            [MethodImpl(MethodImplOptions.InternalCall)]
            void remove_DocumentTitleChanged([In] EventRegistrationToken token);
            [MethodImpl(MethodImplOptions.InternalCall)]
            // TODO: Should this be a return value or an out param?
            [return: MarshalAs(UnmanagedType.LPWStr)]
        ...
        {
            [MethodImpl(MethodImplOptions.InternalCall)]
            void AddRemoteObject([MarshalAs(UnmanagedType.LPWStr)] [In] string name, object obj);
            [MethodImpl(MethodImplOptions.InternalCall)]
            void RemoveRemoteObject([MarshalAs(UnmanagedType.LPWStr)] [In] string name);
            [MethodImpl(MethodImplOptions.InternalCall)]
            void OpenDevToolsWindow();
            [MethodImpl(MethodImplOptions.InternalCall)]
            void add_AcceleratorKeyPressed([MarshalAs(UnmanagedType.Interface)] [In] IWebView2AcceleratorKeyPressedEventHandler eventHandler, out EventRegistrationToken token);
            [MethodImpl(MethodImplOptions.InternalCall)]
        ...
        {
            [MethodImpl(MethodImplOptions.InternalCall)]
            int get_AreDefaultContextMenusEnabled();
            [MethodImpl(MethodImplOptions.InternalCall)]
            void put_AreDefaultContextMenusEnabled([In] int enabled);
        }
        #endregion
        ...
        public enum WEBVIEW2_KEY_EVENT_TYPE
        {
        ...
        [Guid("64C29E6D-BA57-4EBA-A14F-71697F4F3D86"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
        [ComImport]
        public interface IWebView2AcceleratorKeyPressedEventArgs
        {
            [MethodImpl(MethodImplOptions.InternalCall)]
            WEBVIEW2_KEY_EVENT_TYPE get_KeyEventType();
            [MethodImpl(MethodImplOptions.InternalCall)]
            uint get_VirtualKey();
            [MethodImpl(MethodImplOptions.InternalCall)]
            int get_KeyEventLParam();
            [MethodImpl(MethodImplOptions.InternalCall)]
            WEBVIEW2_PHYSICAL_KEY_STATUS get_PhysicalKeyStatus();
            [MethodImpl(MethodImplOptions.InternalCall)]
        ...
        [Guid("0256DA7B-2BF7-4B12-8ECA-EFFCB28C2CD8"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
        [ComImport]
        public interface IWebView2NewVersionAvailableEventArgs
        {
            [MethodImpl(MethodImplOptions.InternalCall)]
            [return: MarshalAs(UnmanagedType.LPWStr)]
            string get_NewVersion();
        }

        [Guid("1f6e4074-bc3d-4381-ba8a-cf65feaa036a"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
        [ComImport]
        public interface IWebView2NewWindowRequestedEventArgs
        {
            ...
            [MethodImpl(MethodImplOptions.InternalCall)]
            void put_NewWindow([MarshalAs(UnmanagedType.Interface)] [In] IWebView2WebView newWindow);
            [MethodImpl(MethodImplOptions.InternalCall)]
            [return: MarshalAs(UnmanagedType.Interface)]
            IWebView2WebView get_NewWindow();
        ...
        [Guid("53E3676B-287C-4967-B7E2-DA0448BEB0F1"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
        [ComImport]
        ...
        [Guid("E190F4F4-7C94-4CB3-BA4D-DDCDA7AC7693"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
        [ComImport]
        ...
        [Guid("9E21312F-6FE7-4118-8CA1-6317C9CD627B"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
        [ComImport]
        ...
        [Guid("1daa050a-98de-44ad-b5bb-935c8b9c7c0b"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
        [ComImport]
